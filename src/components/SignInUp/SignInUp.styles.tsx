...
interface SuccessMessageContainerProps {
  display: string;
}
...
export const FormSubtext = styled.h2<FormSubtextProps>`
...
export const SuccessMessageContainer = styled.div<SuccessMessageContainerProps>`
