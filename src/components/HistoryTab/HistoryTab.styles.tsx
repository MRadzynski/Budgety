...
interface HistoryChartBalanceProps {
  balance: Number;
}
...
export const ExpandArrow = styled.span<ExpandArrowProps>`
...
export const HistoryChartBalance = styled.h2<HistoryChartBalanceProps>`
  color: ${({ balance }) =>
    balance > 0
      ? 'var(--successMessage)'
      : balance < 0
